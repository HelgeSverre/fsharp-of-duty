...
module Tuning =
    ...
    /// Special-weapon tuning. Their physical mechanisms stay offline; Bow is
    /// the deliberate exception and resolves its released charge as hitscan
    /// online until projectile replication is added.
    let paintballMarker =
